export default {
  ...
  video: {
    ...
    klingElementFrameConflict:
      "❌ First/last frame and element slots cannot be used together for this model. Please remove the frame or the element and try again.",
