  ...
  "nano-banana-pro": {
    ...
    settings: [
      ...
      },
      {
        ...
        description: "Разрешить модели обращаться к интернету для уточнения деталей промпта.",
        type: "toggle",
        default: false,
      },
    ],
  ...
  "nano-banana-2": {
    ...
    settings: [
      ...
      },
      {
        ...
        label: "Разрешение",
        description:
          "Детализация итогового изображения: 0.5K — быстро, 1K — стандарт, 4K — максимальные детали.",
        type: "select",
        options: [
      ...
      },
      {
        ...
        description:
          "Minimal — лёгкое усиление следования инструкциям, High — глубокий анализ промпта. Отключить — без дополнительного мышления.",
        type: "select",
        options: [
